    ...
    if (!($("#discord-popup").length)) {
        ...
        let fakeJSX = `<div id="discord-popup">
                        <div class="popup-wrapper">
                            ...
                            <div id="content">
                                <p>To link wallets, switch to each one you want to link and connect. Assign a label and sign a message with it, then click "SET LINKS" to complete linking. </p>
                                <div id="links-view">
